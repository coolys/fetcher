...
import io.cooly.crawler.FetcherApp;
import io.cooly.crawler.config.SecurityBeanOverrideConfiguration;
import io.cooly.crawler.web.rest.vm.LoggerVM;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, FetcherApp.class})
